...
import 'package:kidgo/components/form/form_item.dart/extension/display_ext.dart';
import 'package:kidgo/components/form/form_item.dart/extension/validator_ext.dart';
...
class FormItem<T> {
  ...
  bool get isRequired => lableText?.endsWith('*') ?? _isRequired;
